  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <div>
            ...
            <p className="text-muted-foreground max-w-xl">
              A curated set of real-world projects focused on performance,
              scalability, and refined UI.
            </p>
          </div>
        ...
        <div
          ref={scrollRef}
          className="flex gap-6 sm:gap-10 overflow-x-auto snap-x snap-mandatory
          scrollbar-hide pb-6 touch-pan-x"
        >
                ...
                <div className="relative z-10 h-full p-6 sm:p-8 flex flex-col justify-end text-white">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div
                      ...
                      backdrop-blur group-hover:bg-white/10 transition"
                    >
